...
const Hero = () => {
    return (
        <section className="relative pt-40 pb-20 md:pt-64 md:pb-32 px-6 md:px-8">
            <div className="max-w-7xl mx-auto text-center relative z-10">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6">
                    <button className="w-full md:w-auto bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-5 md:px-14 md:py-6 rounded-[1.5rem] md:rounded-[2rem] font-black text-lg md:text-xl flex items-center justify-center gap-4 shadow-[0_20px_50px_rgba(6,182,212,0.4)] hover:-translate-y-2 transition-all">
                        Launch Your Idea <ArrowRight size={20} className="md:w-6 md:h-6" />
                    </button>
                    <a href="mailto:info@cubitit.com" className="w-full md:w-auto px-8 py-5 md:px-14 md:py-6 rounded-[1.5rem] md:rounded-[2rem] font-black text-lg md:text-xl flex items-center justify-center gap-4 bg-white/5 border border-white/10 text-white hover:bg-white/10 transition-all backdrop-blur-sm">
